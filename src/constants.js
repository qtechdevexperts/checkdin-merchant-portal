...
export const AUTH_FORGOTPASSWORD_URL = "https://api.chekdin.com/api/v1/auth/forget-password";
export const AUTH_CONFIRMFORGOTPASSWORD_URL = "https://api.chekdin.com/api/v1/auth/change-password";
